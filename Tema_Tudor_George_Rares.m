clc
D=30;%avem un semanal triunghiular simetric monoalernant de durata D=30
...
rezolutia=0.09; %am ales rezolutia temporara de 0.9 ms
...
%avem un semnal triunghiular redresat monoalternanta de perioada T=72
C = zeros(1,2*N+1);
